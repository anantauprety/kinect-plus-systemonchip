...
#define SPIM_1_InternalClockUsed          (0u)
...
#define SPIM_1_INT_ON_SPI_DONE    (1u << SPIM_1_STS_SPI_DONE_SHIFT)
#define SPIM_1_INT_ON_TX_EMPTY    (1u << SPIM_1_STS_TX_FIFO_EMPTY_SHIFT)
#define SPIM_1_INT_ON_TX_NOT_FULL (1u << SPIM_1_STS_TX_FIFO_NOT_FULL_SHIFT)
#define SPIM_1_INT_ON_BYTE_COMP   (0u << SPIM_1_STS_BYTE_COMPLETE_SHIFT)
#define SPIM_1_INT_ON_SPI_IDLE    (1u << SPIM_1_STS_SPI_IDLE_SHIFT)
...
#define SPIM_1_INT_ON_RX_FULL      (1u << SPIM_1_STS_RX_FIFO_FULL_SHIFT)
#define SPIM_1_INT_ON_RX_NOT_EMPTY (1u << SPIM_1_STS_RX_FIFO_NOT_EMPTY_SHIFT)
#define SPIM_1_INT_ON_RX_OVER      (1u << SPIM_1_STS_RX_FIFO_OVERRUN_SHIFT)
