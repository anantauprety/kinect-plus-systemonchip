...
#define CapSense_PRESCALER_VALUE            (11u)
...
/* PSoC3 ES2 or early */
#define CapSense_PSOC3_ES2  ( (CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                      (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_3A_ES2) )
                     
/* PSoC5 ES1 or early */
#define CapSense_PSOC5_ES1  ( (CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                                      (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_5A_ES1) )
/* PSoC3 ES3 or later */
#define CapSense_PSOC3_ES3  ( (CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                      (CYDEV_CHIP_REVISION_USED >= CYDEV_CHIP_REVISION_3A_ES3) )
                     
/* PSoC5 ES2 or later */
#define CapSense_PSOC5_ES2  ( (CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                                      (CYDEV_CHIP_REVISION_USED > CYDEV_CHIP_REVISION_5A_ES1) )
...
typedef struct _CapSense_BACKUP_STRUCT
{
    ...
    /* Set Prescaler */
        ...
        #if (CapSense_PSOC3_ES2 || CapSense_PSOC5_ES1)
            uint8 prescaler;
        #endif  /* End (CapSense_PSOC3_ES2 || CapSense_PSOC5_ES1) */
...
#if (CapSense_DESIGN_TYPE == CapSense_TWO_CHANNELS_DESIGN)
    #if(CapSense_TOTAL_SENSOR_COUNT__CH0 > CapSense_TOTAL_SENSOR_COUNT__CH1)
        #define CapSense_TOTAL_SCANSLOT_COUNT   CapSense_TOTAL_SENSOR_COUNT__CH0
    #else
        #define CapSense_TOTAL_SCANSLOT_COUNT   CapSense_TOTAL_SENSOR_COUNT__CH1
    #endif  /* End (CapSense_TOTAL_SENSOR_COUNT__CH0 > CapSense_TOTAL_SENSOR_COUNT__CH1) */
    
    #define CapSense_END_OF_SCAN__CH0     CapSense_TOTAL_SCANSLOT_COUNT
    #define CapSense_END_OF_SCAN__CH1     (CapSense_TOTAL_SCANSLOT_COUNT + \
                                                   CapSense_TOTAL_SENSOR_COUNT__CH0)
#else
    #define CapSense_TOTAL_SCANSLOT_COUNT   CapSense_TOTAL_SENSOR_COUNT 
...
#define CapSense_CONTROL_REG    (*(reg8 *) \
                                            CapSense_ClockGen_AsyncCtrl_CtrlReg__CONTROL_REG )
...
#define CapSense_IsrCH0_ISR_PRIORITY      CapSense_IsrCH0__INTC_PRIOR_NUM
...
#if (CapSense_PSOC3_ES2 && (CapSense_IsrCH0__ES2_PATCH))
    #include <intrins.h>
    #define CapSense_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
#endif  /* End (CapSense_PSOC3_ES2 && (CapSense_IsrCH0__ES2_PATCH)) */
    ...
    #if (CapSense_PSOC3_ES2 && (CapSense_IsrCH1__ES2_PATCH))
        #include <intrins.h>
        #define CapSense_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
    #endif  /* End (CapSense_PSOC3_ES2 && (CapSense_IsrCH1__ES2_PATCH)) */
...
/* Idac REGs definitions */
    ...
    /* Idac REGs Channel 0*/
    #define CapSense_IdacCH0_CR0_REG            (*(reg8 *) CapSense_IdacCH0__CR0 )
    #define CapSense_IdacCH0_CR0_PTR            ( (reg8 *) CapSense_IdacCH0__CR0 )
    
    #define CapSense_IdacCH0_CR1_REG            (*(reg8 *) CapSense_IdacCH0__CR1 )
    #define CapSense_IdacCH0_CR1_PTR            ( (reg8 *) CapSense_IdacCH0__CR1 )
    
    #define CapSense_IdacCH0_DATA_REG           (*(reg8 *) CapSense_IdacCH0__D )
    #define CapSense_IdacCH0_DATA_PTR           ( (reg8 *) CapSense_IdacCH0__D )
    
    #define CapSense_IdacCH0_STROBE_REG         (*(reg8 *) CapSense_IdacCH0__STROBE )
    #define CapSense_IdacCH0_STROBE_PTR         ( (reg8 *) CapSense_IdacCH0__STROBE )
    
    #define CapSense_IdacCH0_TR_REG             (*(reg8 *) CapSense_IdacCH0__TR )
    #define CapSense_IdacCH0_TR_PTR             ( (reg8 *) CapSense_IdacCH0__TR )
    
    #define CapSense_IdacCH0_ACT_PWRMGR_REG     (*(reg8 *) CapSense_IdacCH0__PM_ACT_CFG )
    #define CapSense_IdacCH0_ACT_PWRMGR_PTR     ( (reg8 *) CapSense_IdacCH0__PM_ACT_CFG )
    #define CapSense_IdacCH0_ACT_PWR_EN                    CapSense_IdacCH0__PM_ACT_MSK
    
    #define CapSense_IdacCH0_STBY_PWRMGR_REG    (*(reg8 *) CapSense_IdacCH0__PM_STBY_CFG )
    #define CapSense_IdacCH0_STBY_PWRMGR_PTR    ( (reg8 *) CapSense_IdacCH0__PM_STBY_CFG )
    #define CapSense_IdacCH0_STBY_PWR_EN                   CapSense_IdacCH0__PM_STBY_MSK
    
    /* Define DAC Trim base */
    #define CapSense_IdacCH0_DAC_TRIM_BASE      CapSense_IdacCH0__TRIM__M1

    #if (CapSense_DESIGN_TYPE == CapSense_TWO_CHANNELS_DESIGN)
        /* Idac REGs Channel 1 */
        #define CapSense_IdacCH1_CR0_REG            (*(reg8 *) CapSense_IdacCH1__CR0 )
        #define CapSense_IdacCH1_CR0_PTR            ( (reg8 *) CapSense_IdacCH1__CR0 )
        
        #define CapSense_IdacCH1_CR1_REG            (*(reg8 *) CapSense_IdacCH1__CR1 )
        #define CapSense_IdacCH1_CR1_PTR            ( (reg8 *) CapSense_IdacCH1__CR1 )
        
        #define CapSense_IdacCH1_DATA_REG           (*(reg8 *) CapSense_IdacCH1__D )
        #define CapSense_IdacCH1_DATA_PTR           ( (reg8 *) CapSense_IdacCH1__D )
        
        #define CapSense_IdacCH1_STROBE_REG         (*(reg8 *) CapSense_IdacCH1__STROBE )
        #define CapSense_IdacCH1_STROBE_PTR         ( (reg8 *) CapSense_IdacCH1__STROBE )
        
        #define CapSense_IdacCH1_TR_REG             (*(reg8 *) CapSense_IdacCH1__TR )
        #define CapSense_IdacCH1_TR_PTR             ( (reg8 *) CapSense_IdacCH1__TR )
        
        #define CapSense_IdacCH1_ACT_PWRMGR_REG     (*(reg8 *) CapSense_IdacCH1__PM_ACT_CFG )
        #define CapSense_IdacCH1_ACT_PWRMGR_PTR     ( (reg8 *) CapSense_IdacCH1__PM_ACT_CFG )
        #define CapSense_IdacCH1_ACT_PWR_EN                    CapSense_IdacCH1__PM_ACT_MSK
        
        #define CapSense_IdacCH1_STBY_PWRMGR_REG    (*(reg8 *) CapSense_IdacCH1__PM_STBY_CFG )
        #define CapSense_IdacCH1_STBY_PWRMGR_PTR    ( (reg8 *) CapSense_IdacCH1__PM_STBY_CFG )
        #define CapSense_IdacCH1_STBY_PWR_EN                   CapSense_IdacCH1__PM_STBY_MSK
        
        /* Define DAC Trim base */
        #define CapSense_IdacCH1_DAC_TRIM_BASE      CapSense_IdacCH1__TRIM__M1
...
/* Define direction of Current - Souce as Sink */
    ...
    #define CapSense_IdacCH0_IDIR      CapSense_IDAC_IDIR_SRC
    #define CapSense_IdacCH1_IDIR      CapSense_IDAC_IDIR_SRC
#elif (CapSense_CURRENT_SOURCE == CapSense_IDAC_SINK)
    #define CapSense_IdacCH0_IDIR      CapSense_IDAC_IDIR_SINK
    #define CapSense_IdacCH1_IDIR      CapSense_IDAC_IDIR_SINK
#else
    /* No Idac - Rb selected */
#endif  /* End (CapSense_CURRENT_SOURCE == CapSense_IDAC_SOURCE) */
...
#endif /* End CY_CAPSENSE_CSD_CapSense_H */
