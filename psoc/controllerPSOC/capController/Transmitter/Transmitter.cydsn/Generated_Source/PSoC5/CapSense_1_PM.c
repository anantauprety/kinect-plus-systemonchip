...
{   
    0x00u, /* enableState; */
            ...
            CapSense_1_PRESCALER_VALUE, /* prescaler value */ 
...
{    
    ...
    #if (CapSense_1_PRESCALER_OPTIONS == CapSense_1_PRESCALER_UDB)
        #if (CapSense_1_PSOC3_ES2 || CapSense_1_PSOC5_ES1)
            CapSense_1_backup.prescaler  = CapSense_1_PRESCALER_PERIOD_REG; 
        #endif  /* End (CapSense_1_PSOC3_ES2 || CapSense_1_PSOC5_ES1) */
    #endif  /* End (CapSense_1_PRESCALER_OPTIONS == CapSense_1_PRESCALER_UDB) */
...
{   
          ...
          (CapSense_1_PSOC3_ES2 || CapSense_1_PSOC5_ES1) )
    ...
    #if (CapSense_1_PRESCALER_OPTIONS == CapSense_1_PRESCALER_UDB)
        #if (CapSense_1_PSOC3_ES2 || CapSense_1_PSOC5_ES1)
            CapSense_1_PRESCALER_PERIOD_REG  = CapSense_1_backup.prescaler;              /* D0 register */
            CapSense_1_PRESCALER_COMPARE_REG = (CapSense_1_backup.prescaler >> 0x01u);   /* D1 register */
        #endif  /* End (CapSense_1_PSOC3_ES2 || CapSense_1_PSOC5_ES1) */
