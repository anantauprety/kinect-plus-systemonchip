...
void CapSense_1_Init(void) 
{
    ...
    /* Set Prescaler */
        ...
        CapSense_1_PRESCALER_PERIOD_REG  = CapSense_1_PRESCALER_VALUE;
        CapSense_1_PRESCALER_COMPARE_REG = (CapSense_1_PRESCALER_VALUE >> 0x01u);
...
void CapSense_1_SetScanSlotSettings(uint8 slot) 
{
    uint8 widget;
        ...
        {
            slot += CapSense_1_TOTAL_SENSOR_COUNT__CH0;
            widget = CapSense_1_widgetNumber[slot];
