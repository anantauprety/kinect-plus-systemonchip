...
/* PSoC3 ES2 or early */
#define CapSense_CompCH0_PSOC3_ES2  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A)    && \
                                    (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_3A_ES2))                    
/* PSoC5 ES1 or early */
#define CapSense_CompCH0_PSOC5_ES1  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A)    && \
                                    (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_5A_ES1))
/* PSoC3 ES3 or later */
#define CapSense_CompCH0_PSOC3_ES3  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A)    && \
                                    (CYDEV_CHIP_REVISION_USED > CYDEV_CHIP_REVISION_3A_ES2))                    
/* PSoC5 ES2 or later */
#define CapSense_CompCH0_PSOC5_ES2  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A)    && \
                                    (CYDEV_CHIP_REVISION_USED > CYDEV_CHIP_REVISION_5A_ES1))
...
#define CapSense_CompCH0_CLK     (* (reg8 *) CapSense_CompCH0_ctComp__CLK )  /* Comp clock comtrol register */
...
/* PSoC3 ES3 or later, PSoC5 ES2 or later */
#if (CapSense_CompCH0_PSOC3_ES3 || CapSense_CompCH0_PSOC5_ES2)
    #define CapSense_CompCH0_CMP_TR0_DIR 0x11u    /* Trim direction for N-type load for offset calibration */
    #define CapSense_CompCH0_CMP_TR0_MASK 0x1Fu   /* Trim for N-type load for offset calibration */
    #define CapSense_CompCH0_CMP_TR1_DIR 0x10u    /* Trim direction for P-type load for offset calibration */
    #define CapSense_CompCH0_CMP_TR1_MASK 0x1Fu   /* Trim for P-type load for offset calibration */ 
#endif
