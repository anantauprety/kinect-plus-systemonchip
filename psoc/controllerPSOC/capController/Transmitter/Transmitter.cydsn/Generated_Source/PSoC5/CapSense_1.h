...
#define CapSense_1_PRESCALER_VALUE            (11u)
...
#define CapSense_1_TUNER_API_GENERATE         (1u)
...
/* PSoC3 ES2 or early */
#define CapSense_1_PSOC3_ES2  ( (CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                      (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_3A_ES2) )
                     
/* PSoC5 ES1 or early */
#define CapSense_1_PSOC5_ES1  ( (CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                                      (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_5A_ES1) )
/* PSoC3 ES3 or later */
#define CapSense_1_PSOC3_ES3  ( (CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                      (CYDEV_CHIP_REVISION_USED >= CYDEV_CHIP_REVISION_3A_ES3) )
                     
/* PSoC5 ES2 or later */
#define CapSense_1_PSOC5_ES2  ( (CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                                      (CYDEV_CHIP_REVISION_USED > CYDEV_CHIP_REVISION_5A_ES1) )
...
typedef struct _CapSense_1_BACKUP_STRUCT
{
    ...
    /* Set Prescaler */
        ...
        #if (CapSense_1_PSOC3_ES2 || CapSense_1_PSOC5_ES1)
            uint8 prescaler;
        #endif  /* End (CapSense_1_PSOC3_ES2 || CapSense_1_PSOC5_ES1) */
...
#if (CapSense_1_DESIGN_TYPE == CapSense_1_TWO_CHANNELS_DESIGN)
    #if(CapSense_1_TOTAL_SENSOR_COUNT__CH0 > CapSense_1_TOTAL_SENSOR_COUNT__CH1)
        #define CapSense_1_TOTAL_SCANSLOT_COUNT   CapSense_1_TOTAL_SENSOR_COUNT__CH0
    #else
        #define CapSense_1_TOTAL_SCANSLOT_COUNT   CapSense_1_TOTAL_SENSOR_COUNT__CH1
    #endif  /* End (CapSense_1_TOTAL_SENSOR_COUNT__CH0 > CapSense_1_TOTAL_SENSOR_COUNT__CH1) */
    
    #define CapSense_1_END_OF_SCAN__CH0     CapSense_1_TOTAL_SCANSLOT_COUNT
    #define CapSense_1_END_OF_SCAN__CH1     (CapSense_1_TOTAL_SCANSLOT_COUNT + \
                                                   CapSense_1_TOTAL_SENSOR_COUNT__CH0)
#else
    #define CapSense_1_TOTAL_SCANSLOT_COUNT   CapSense_1_TOTAL_SENSOR_COUNT 
...
#define CapSense_1_IsrCH0_ISR_PRIORITY      CapSense_1_IsrCH0__INTC_PRIOR_NUM
...
#if (CapSense_1_PSOC3_ES2 && (CapSense_1_IsrCH0__ES2_PATCH))
    #include <intrins.h>
    #define CapSense_1_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
#endif  /* End (CapSense_1_PSOC3_ES2 && (CapSense_1_IsrCH0__ES2_PATCH)) */
    ...
    #if (CapSense_1_PSOC3_ES2 && (CapSense_1_IsrCH1__ES2_PATCH))
        #include <intrins.h>
        #define CapSense_1_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
    #endif  /* End (CapSense_1_PSOC3_ES2 && (CapSense_1_IsrCH1__ES2_PATCH)) */
