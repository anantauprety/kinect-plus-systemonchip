...
void CapSense_Init(void) 
{
    ...
    /* Set Prescaler */
        ...
        CapSense_PRESCALER_PERIOD_REG  = CapSense_PRESCALER_VALUE;
        CapSense_PRESCALER_COMPARE_REG = (CapSense_PRESCALER_VALUE >> 0x01u);
...
void CapSense_SetScanSlotSettings(uint8 slot) 
{
    uint8 widget;
        ...
        {
            slot += CapSense_TOTAL_SENSOR_COUNT__CH0;
            widget = CapSense_widgetNumber[slot];
