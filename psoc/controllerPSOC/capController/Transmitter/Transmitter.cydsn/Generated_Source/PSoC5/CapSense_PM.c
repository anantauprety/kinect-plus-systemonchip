...
{   
    0x00u, /* enableState; */
            ...
            CapSense_PRESCALER_VALUE, /* prescaler value */ 
...
{    
    ...
    #if (CapSense_PRESCALER_OPTIONS == CapSense_PRESCALER_UDB)
        #if (CapSense_PSOC3_ES2 || CapSense_PSOC5_ES1)
            CapSense_backup.prescaler  = CapSense_PRESCALER_PERIOD_REG; 
        #endif  /* End (CapSense_PSOC3_ES2 || CapSense_PSOC5_ES1) */
    #endif  /* End (CapSense_PRESCALER_OPTIONS == CapSense_PRESCALER_UDB) */
...
{   
          ...
          (CapSense_PSOC3_ES2 || CapSense_PSOC5_ES1) )
    ...
    #if (CapSense_PRESCALER_OPTIONS == CapSense_PRESCALER_UDB)
        #if (CapSense_PSOC3_ES2 || CapSense_PSOC5_ES1)
            CapSense_PRESCALER_PERIOD_REG  = CapSense_backup.prescaler;              /* D0 register */
            CapSense_PRESCALER_COMPARE_REG = (CapSense_backup.prescaler >> 0x01u);   /* D1 register */
        #endif  /* End (CapSense_PSOC3_ES2 || CapSense_PSOC5_ES1) */
