 ...
 void CapSense_UpdateSensorBaseline(uint8 sensor)
{
    ...
    #else
        /* No Raw filters */
    #endif  /* End (CapSense_RAW_FILTER_MASK & CapSense_MEDIAN_FILTER) */
...
void CapSense_DisableWidget(uint8 widget)
{
    ...
    *
    *******************************************************************************/
    uint8 CapSense_CalcCentroid(uint8 maximum, uint8 offset, uint8 count, uint16 resolution, uint8 noiseThreshold)
    {
                    ...
                    else
                    {
                        /* Do filtering */
                            ...
                            if (0u != (posFiltersMask & CapSense_MEDIAN_FILTER))
                            {
                                ...
                                position = CapSense_MedianFilter(position, CapSense_posFiltersData[posIndex], CapSense_posFiltersData[posIndex + 1u]);
                            ...
                            {
                                tempPos = (uint8) position;
                                position = CapSense_AveragingFilter(position, CapSense_posFiltersData[posIndex], CapSense_posFiltersData[posIndex + 1u]);
                                CapSense_posFiltersData[posIndex + 1u] = CapSense_posFiltersData[posIndex];
                                CapSense_posFiltersData[posIndex] = tempPos;
                            }
                        #endif
                            ...
                            {
                                position = CapSense_JitterFilter(position, CapSense_posFiltersData[posIndex]);
                                CapSense_posFiltersData[posIndex] = (uint8) position;
                            }
                        #endif
                    }
                ...
                if (0u != (posFiltersMask & CapSense_ANY_POS_FILTER))
                {
                    ...
                    else
                    {
                        /* Do filtering */
                            ...
                            {
                                tempPos = (uint8) position;
                                position = CapSense_AveragingFilter(position, CapSense_posFiltersData[posIndex], 
                                  CapSense_posFiltersData[posIndex + 1u]);
                                CapSense_posFiltersData[posIndex + 1u] = CapSense_posFiltersData[posIndex];
                                CapSense_posFiltersData[posIndex] = tempPos;
                            }
                    ...
                    if (0u != (posFiltersMask & CapSense_ANY_POS_FILTER))
                    {
                        ...
                        else
                        {
                            /* Do filtering */
                                ...
                                {
                                    tempPos = posX;
                                    posX = (uint8) CapSense_MedianFilter(posX, CapSense_posFiltersData[posXIndex], 
                                      CapSense_posFiltersData[posXIndex + 1u]);
                                    CapSense_posFiltersData[posXIndex + 1u] = CapSense_posFiltersData[posXIndex];
                                    CapSense_posFiltersData[posXIndex] = tempPos;
                                    
                                    tempPos = posY;
                                    posY = (uint8) CapSense_MedianFilter(posY, CapSense_posFiltersData[posYIndex], 
                                      CapSense_posFiltersData[posYIndex + 1u]);
                                    CapSense_posFiltersData[posYIndex + 1u] = CapSense_posFiltersData[posYIndex];
                                ...
                                {
                                    tempPos = posX;
                                    posX = (uint8) CapSense_AveragingFilter(posX, CapSense_posFiltersData[posXIndex], 
                                      CapSense_posFiltersData[posXIndex + 1u]);
                                    CapSense_posFiltersData[posXIndex + 1u] = CapSense_posFiltersData[posXIndex];
                                    CapSense_posFiltersData[posXIndex] = tempPos;
                                    
                                    tempPos = posY;
                                    posY = (uint8) CapSense_AveragingFilter(posY, CapSense_posFiltersData[posYIndex], 
                                      CapSense_posFiltersData[posYIndex + 1u]);
                                    CapSense_posFiltersData[posYIndex + 1u] = CapSense_posFiltersData[posYIndex];
                                    CapSense_posFiltersData[posYIndex] = tempPos;
                                }
                                ...
                                if (0u != (posFiltersMask & CapSense_IIR2_FILTER))
                                {
                                    posX = (uint8) CapSense_IIR2Filter(posX, CapSense_posFiltersData[posXIndex]);
                                    CapSense_posFiltersData[posXIndex] = posX;
                                    
                                    posY = (uint8) CapSense_IIR2Filter(posY, CapSense_posFiltersData[posYIndex]);
                                    CapSense_posFiltersData[posYIndex] = posY;
                                }
                                ...
                                if (0u != (posFiltersMask & CapSense_IIR4_FILTER))
                                {
                                    posX = (uint8) CapSense_IIR4Filter(posX, CapSense_posFiltersData[posXIndex]);
                                    CapSense_posFiltersData[posXIndex] = posX;
                                    
                                    posY = (uint8) CapSense_IIR4Filter(posY, CapSense_posFiltersData[posYIndex]);
                                    CapSense_posFiltersData[posYIndex] = posY;
                                }
                                ...
                                if (0u != (posFiltersMask & CapSense_JITTER_FILTER))
                                    {
                                        posX = (uint8) CapSense_JitterFilter(posX, CapSense_posFiltersData[posXIndex]);
                                        CapSense_posFiltersData[posXIndex] = posX;
                                        
                                        posY = (uint8) CapSense_JitterFilter(posY, CapSense_posFiltersData[posYIndex]);
                                        CapSense_posFiltersData[posYIndex] = posY;
                                    }
                            #endif
                        }
