...
/* Idac functions definitions */
    ...
    void CapSense_SetIdacRange(uint8 range) ;
    ...
    void CapSense_SetPrescaler(uint8 prescaler) ;
...
void CapSense_Init(void) 
{
    ...
    #endif /* End ( (CapSense_PRS_OPTIONS) || \
                    (CapSense_IMPLEMENTATION_CH0 == CapSense_MEASURE_IMPLEMENTATION_UDB) || \
                    ( (CapSense_DESIGN_TYPE == CapSense_TWO_CHANNELS_DESIGN) && \
                      (CapSense_IMPLEMENTATION_CH1 == CapSense_MEASURE_IMPLEMENTATION_UDB)) ) */
...
void CapSense_Enable(void) 
{
    ...
    #endif  /* End CapSense_CLOCK_SOURCE */
...
void CapSense_PreScan(uint8 sensor) 
{
    ...
    *******************************************************************************/
    void CapSense_PostScan(uint8 sensor)
    {
        ...
        #endif  /* End (CapSense_IMPLEMENTATION == CapSense_MEASURE_IMPLEMENTATION_FF)*/
    ...
    *******************************************************************************/
    void CapSense_IdacCH0_Init(void) 
    {
        ...
        CapSense_IdacCH0_CR0_REG = CapSense_IDAC_MODE_I;
        
        /* Set Source/Sink direction and source of control */
        CapSense_IdacCH0_CR1_REG = CapSense_IdacCH0_IDIR | CapSense_IDAC_IDIR_CTL_UDB;
    ...
    *******************************************************************************/
    void CapSense_IdacCH0_Enable(void) 
    {
        /* Set I mode of operation */
        #if (CY_PSOC3_ES2 || CY_PSOC5_ES1)
            if (0u != (CapSense_idac_cfg_restore & CapSense_IdacCH0_RESTORE_CFG))
            {
                CapSense_idac_cfg_restore &= ~CapSense_IdacCH0_RESTORE_CFG;
                CapSense_IdacCH0_CR0_REG = CapSense_idac_ch0_cr0reg;
            }
        #endif  /* End (CY_PSOC3_ES2 || CY_PSOC5_ES1) */
        
        /* Enable power to DAC */
        CapSense_IdacCH0_ACT_PWRMGR_REG  |= CapSense_IdacCH0_ACT_PWR_EN;
        CapSense_IdacCH0_STBY_PWRMGR_REG |= CapSense_IdacCH0_STBY_PWR_EN;
    }
    ...
    *******************************************************************************/
    void CapSense_IdacCH0_Stop(void) 
    {
        ...
        #if (CY_PSOC3_ES2 || CY_PSOC5_ES1)
            CapSense_idac_cfg_restore |= CapSense_IdacCH0_RESTORE_CFG;
            CapSense_idac_ch0_cr0reg = CapSense_IdacCH0_CR0_REG;
            CapSense_IdacCH0_CR0_REG = CapSense_IDAC_STOP_CR0_VAL;
        #endif   /* End (CY_PSOC3_ES2 || CY_PSOC5_ES1) */
    }
    ...
    *******************************************************************************/
    void CapSense_IdacCH0_SetValue(uint8 value) 
    {
        ...
        /* Set Value */
        CapSense_IdacCH0_DATA_REG = value;
    ...
    *******************************************************************************/
    void CapSense_IdacCH0_DacTrim(void) 
    {
        ...
        mode = ((CapSense_IdacCH0_CR0_REG & CapSense_IDAC_RANGE_MASK) >> 1u);
        
        if((CapSense_IDAC_IDIR_MASK & CapSense_IdacCH0_CR1_REG) == CapSense_IDAC_IDIR_SINK)
        {
            mode++;
        }
        
        CapSense_IdacCH0_TR_REG = CY_GET_XTND_REG8((uint8 *)(CapSense_IdacCH0_DAC_TRIM_BASE + mode));
    }
    ...
    *******************************************************************************/
    ...
    {
        /* Clear existing mode */
        CapSense_IdacCH0_CR0_REG &= ~CapSense_IDAC_RANGE_MASK;
        
        /* Set Range */
        CapSense_IdacCH0_CR0_REG |= (range & CapSense_IDAC_RANGE_MASK);
    ...
    *******************************************************************************/
    void CapSense_SetIdacRange(uint8 range)   
    {
        CapSense_IdacCH0_SetRange(range);
        #if (CapSense_DESIGN_TYPE == CapSense_TWO_CHANNELS_DESIGN)
