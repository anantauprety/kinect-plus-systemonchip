...
module Comp_v1_70_1 (Vplus, CmpOut, Vminus, clock);
    inout   Vplus;
    electrical   Vplus;
    output  CmpOut;
    inout   Vminus;
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_vref_v1_50"
`include "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_vref_v1_50\cy_vref_v1_50.v"
`endif
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CapSense_CSD_AMux_v3_10"
`include "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CapSense_CSD_AMux_v3_10\CapSense_CSD_AMux_v3_10.v"
`endif
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CapSense_CSD_MeasureCh_v3_10"
`include "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CapSense_CSD_MeasureCh_v3_10\CapSense_CSD_MeasureCh_v3_10.v"
`endif
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CapSense_CSD_ClockGen_v3_10"
`include "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CapSense_CSD_ClockGen_v3_10\CapSense_CSD_ClockGen_v3_10.v"
`endif
...
module CapSense_CSD_v3_10_2 (clock, shield, vref, bclk);
	...
	cy_psoc3_port_v1_0
		#(.width(7),
		  ...
		  .pin_aliases({"LinearSlider0_e0","__LS,LinearSlide","r0_e1__LS,Linear","Slider0_e2__LS,L","inearSlider0_e3_","_LS,LinearSlider","0_e4__LS,Button0","__BTN,Button1__B","TN"}),
		  .access_mode("HW_ONLY"),
		  .layout_mode("NONCONTIGUOUS"),
		  .port_mode("ANALOG"),
	...
	cy_clock_v1_0
		#(.id("3f6741e6-c156-431f-bd4b-8734eedf5c5a/0ad1a1a8-974e-43a0-841b-3af08590011d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("3f6741e6-c156-431f-bd4b-8734eedf5c5a/52b807b3-40a8-4a39-b1e7-e18f76c3b871"),
...
// Component: B_SPI_Master_v2_20
`ifdef CY_BLK_DIR
`undef CY_BLK_DIR
`endif

`ifdef WARP
`define CY_BLK_DIR "$CYPRESS_DIR\..\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_20"
`include "$CYPRESS_DIR\..\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_20\B_SPI_Master_v2_20.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_20"
`include "C:\Program Files\Cypress\PSoC Creator\2.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_20\B_SPI_Master_v2_20.v"
`endif

// SPI_Master_v2_20(BidirectMode=false, ClockInternal=false, CtlModeReplacementString=AsyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DesiredBitRate=1000000, InternalClockUsed=0, InternalInterruptEnabled=0, InternalRxInterruptEnabled=0, InternalTxInterruptEnabled=0, InterruptOnByteComplete=false, InterruptOnRXFull=false, InterruptOnRXNotEmpty=false, InterruptOnRXOverrun=false, InterruptOnSPIDone=false, InterruptOnSPIIdle=false, InterruptOnTXEmpty=false, InterruptOnTXNotFull=false, IntOnByteComp=0, IntOnRXFull=0, IntOnRXNotEmpty=0, IntOnRXOver=0, IntOnSPIDone=0, IntOnSPIIdle=0, IntOnTXEmpty=0, IntOnTXNotFull=0, Mode=1, ModeUseZero=1, NumberOfDataBits=8, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, RxBufferSize=4, ShiftDir=0, TxBufferSize=4, UseInternalInterrupt=false, UseRxInternalInterrupt=false, UseTxInternalInterrupt=false, VerilogSectionReplacementString=sR8, CY_COMPONENT_NAME=SPI_Master_v2_20, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=SPIM, CY_INSTANCE_SHORT_NAME=SPIM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=SPIM, )
module SPI_Master_v2_20_3 (clock, reset, miso, sclk, mosi, ss, rx_interrupt, sdat, tx_interrupt);
    input   clock;
    input   reset;
    input   miso;
    output  sclk;
...
module top ;
    ...
    CapSense_CSD_v3_10_2 CapSense (
        .clock(1'b0),
        .shield(Net_30),
        .vref(Net_31),
        .bclk(Net_32));

    SPI_Master_v2_20_3 SPIM (
        .mosi(Net_33),
        .sclk(Net_34),
        .ss(Net_35),
        .miso(Net_36),
