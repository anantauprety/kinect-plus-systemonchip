...
#define CapSense_SENSOR_BUTTON0__BTN    (5u)
#define CapSense_SENSOR_BUTTON1__BTN    (6u)
...
#define CapSense_IsrCH0_ISR_PRIORITY      (CapSense_IsrCH0__INTC_PRIOR_NUM)
...
#if (CY_PSOC3_ES2 && (CapSense_IsrCH0__ES2_PATCH))
    #include <intrins.h>
    #define CapSense_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
#endif  /* End (CY_PSOC3_ES2 && (CapSense_IsrCH0__ES2_PATCH)) */
    ...
    #if (CY_PSOC3_ES2 && (CapSense_IsrCH1__ES2_PATCH))
        #include <intrins.h>
        #define CapSense_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
    #endif  /* End (CY_PSOC3_ES2 && (CapSense_IsrCH1__ES2_PATCH)) */
