...
#define LCD_VERTICAL_BG              (1u)    /* Horizontal Bar Graph */
#define LCD_HORIZONTAL_BG            (2u)    /* Vertical Bar Graph   */
...
#if((LCD_CUSTOM_CHAR_SET == LCD_VERTICAL_BG) || (LCD_CUSTOM_CHAR_SET == LCD_HORIZONTAL_BG))
