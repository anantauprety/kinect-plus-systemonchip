...
#define SPIM_PSOC3_ES2   ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                     			      (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_3A_ES2))
                     
/* PSoC5 ES1 or earlier */
#define SPIM_PSOC5_ES1   ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                     		    	  (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_5A_ES1))
	
#ifdef SPIM_TxInternalInterrupt__ES2_PATCH
	#if(SPIM_PSOC3_ES2 && SPIM_TxInternalInterrupt__ES2_PATCH)
		#include <intrins.h>
        #define SPIM_TX_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
	#endif /* End PSOC3_ES2 */
#endif /* SPIM_TxInternalInterrupt__ES2_PATCH */

#ifdef SPIM_RxInternalInterrupt__ES2_PATCH  
	#if(SPIM_PSOC3_ES2 && SPIM_RxInternalInterrupt__ES2_PATCH)
		#include <intrins.h>
        #define SPIM_RX_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
	#endif /* End PSOC3_ES2 */
...
#define SPIM_InternalClockUsed          (0u)
...
typedef struct _SPIM_backupStruct
{
    ...
    #if(SPIM_PSOC3_ES2 || SPIM_PSOC5_ES1) /* PSoC3 ES2 or earlier, PSoC5 ES1 */
    
        uint8 saveSrTxIntMask;
        uint8 saveSrRxIntMask;
        
    #endif /* End SPIM_PSOC3_ES2 || SPIM_PSOC5_ES1 */
...
#define SPIM_INT_ON_SPI_DONE    (1u << SPIM_STS_SPI_DONE_SHIFT)
#define SPIM_INT_ON_TX_EMPTY    (1u << SPIM_STS_TX_FIFO_EMPTY_SHIFT)
#define SPIM_INT_ON_TX_NOT_FULL (1u << SPIM_STS_TX_FIFO_NOT_FULL_SHIFT)
#define SPIM_INT_ON_BYTE_COMP   (0u << SPIM_STS_BYTE_COMPLETE_SHIFT)
#define SPIM_INT_ON_SPI_IDLE    (1u << SPIM_STS_SPI_IDLE_SHIFT)
...
#define SPIM_INT_ON_RX_FULL      (1u << SPIM_STS_RX_FIFO_FULL_SHIFT)
#define SPIM_INT_ON_RX_NOT_EMPTY (1u << SPIM_STS_RX_FIFO_NOT_EMPTY_SHIFT)
#define SPIM_INT_ON_RX_OVER      (1u << SPIM_STS_RX_FIFO_OVERRUN_SHIFT)
...
#define SPIM_CONTROL_REG         (* (reg8 *)  \
        SPIM_BSPIM_BidirMode_AsyncCtl_CtrlReg__CONTROL_REG)
